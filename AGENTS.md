...
This project is indexed by GitNexus as **TelegramBot** (1463 symbols, 3693 relationships, 123 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
