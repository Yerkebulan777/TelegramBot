...
This project is indexed by GitNexus as **TelegramBot** (1214 symbols, 3072 relationships, 99 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
