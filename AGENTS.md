...
This project is indexed by GitNexus as **TelegramBot** (1233 symbols, 3014 relationships, 99 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
