...
This project is indexed by GitNexus as **TelegramBot** (1221 symbols, 3081 relationships, 100 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
