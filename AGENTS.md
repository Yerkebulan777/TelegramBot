...
This project is indexed by GitNexus as **TelegramBot** (1413 symbols, 3594 relationships, 118 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
