...
**v2.0 (Будущее):**
- [ ] DOC-009: Health checks endpoint (для Kubernetes/orchestration)
- [ ] DOC-010: Лимиты очереди (per-user, per-session)
- [ ] DOC-011: Runbook для operational team
...
- [ ] **Health checks** — эндпоинты для мониторинга здоровья Worker (DOC-009)
- [ ] **Лимиты очереди** — per-user, per-session ограничения (DOC-010)
...
- [ ] **Runbook** — документация для operational team (DOC-011)
