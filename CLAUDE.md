...
This project is indexed by GitNexus as **TelegramBot** (1220 symbols, 3240 relationships, 98 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
