...
This project is indexed by GitNexus as **TelegramBot** (1165 symbols, 3074 relationships, 93 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
