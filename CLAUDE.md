...
This project is indexed by GitNexus as **TelegramBot** (1208 symbols, 2964 relationships, 97 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
