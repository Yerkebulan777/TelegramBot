...
This project is indexed by GitNexus as **TelegramBot** (1022 symbols, 2648 relationships, 85 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
